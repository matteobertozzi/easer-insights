...
PROJECT_IDS="easer-insights-logger easer-insights easer-insights-profiler easer-insights-jdbc easer-insights-aws-cloudwatch example-http-service-insights"
