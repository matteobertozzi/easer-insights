...
public class BasicRootSpan implements RootSpan {
  ...
  public BasicRootSpan(final TraceId traceId, final SpanId parentId, final SpanId spanId) {
  ...
  public String tenantId() {
    return TraceAttributes.TENANT_ID.get(attributes, null);
  }

  @Override
  public String tenant() {
    return TraceAttributes.TENANT_NAME.get(attributes, null);
  }

  @Override
  public String module() {
    return TraceAttributes.MODULE_NAME.get(attributes, null);
  }

  @Override
  public String ownerId() {
    return TraceAttributes.OWNER_ID.get(attributes, null);
  }

  @Override
  public String owner() {
    return TraceAttributes.OWNER_NAME.get(attributes, null);
  }
  ...
  public String toString() {
    return "BasicRootSpan [traceId:" + traceId() + ", spanId:" + spanId + ", name:" + name + ", state:" + state + "]";
  }
}
