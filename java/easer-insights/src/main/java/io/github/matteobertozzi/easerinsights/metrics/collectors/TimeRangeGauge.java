...
public abstract class TimeRangeGauge implements MetricDatumCollector {
  protected TimeRangeGauge() {
    // no-op
  }

  @Override
  public String type() {
    return "TIME_RANGE_GAUGE";
  }

  // ==========================================================================================
  public static TimeRangeGauge newSingleThreaded(final long maxInterval, final long window, final TimeUnit unit) {
    return new TimeRangeGaugeImplSt(maxInterval, window, unit);
  }

  public static TimeRangeGauge newMultiThreaded(final long maxInterval, final long window, final TimeUnit unit) {
    return new TimeRangeGaugeImplMt(maxInterval, window, unit);
  }

  // ==========================================================================================
  protected abstract long add(long timestamp, long value);
  ...
  // ==========================================================================================
  protected static final TimeRangeGaugeSnapshot EMPTY_SNAPSHOT = new TimeRangeGaugeSnapshot(0, 0, new long[0]);
  public record TimeRangeGaugeSnapshot (long lastInterval, long window, long[] counters) implements MetricDataSnapshot {
