...
public class TestMySqlDialect {
  ...
  public void testJdbcUrl() {
    final String[] jdbcUrl = new String[] {
      ...
      "jdbc:mysql://mysql.db.server:3306/my_database?serverTimezone=UTC&autoReconnect=true&useServerPrepStmts=false&rewriteBatchedStatements=true",
      "jdbc:mariadb://localhost:3306/db",
      "jdbc:mysql:aws://db-identifier.cluster-XYZ.us-east-2.rds.amazonaws.com:3306/test?enableClusterAwareFailover=false",
    };
